...
function getAllCustomers() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const result = [];
        try {
            for (var _d = true, _e = __asyncValues(stripe.customers.list({ limit: 100 })), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    const customer = _c;
...
function getAllActiveSubscriptions() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const result = [];
        try {
            for (var _d = true, _e = __asyncValues(stripe.subscriptions.list({
                limit: 100,
                status: 'active',
