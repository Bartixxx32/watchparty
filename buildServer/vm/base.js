...
class VMManager {
    constructor({ isLarge, region, limitSize, minSize }) {
        this.isLarge = false;
        this.region = 'US';
        this.currentSize = 0;
        this.limitSize = 0;
        ...
        this.runBackgroundJobs = () => __awaiter(this, void 0, void 0, function* () {
            try {
                console.log('[VMWORKER] starting background jobs for %s', this.getPoolName());
                ...
                const updateSize = () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (allVMs.length) {
                        ...
                        console.log('[STATS] %s: currentSize %s, available %s, staging %s, buffer %s', this.getPoolName(), allVMs.length, availableKeys.length, stagingKeys.length, this.getAdjustedBuffer());
                    }
                });
                const cleanupVMGroup = () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    let allVMs = [];
                    try {
                        allVMs = yield this.listVMs(this.getTag());
                    }
                    catch (e) {
                    ...
                    console.log('[CLEANUP] %s: cleanup %s VMs', this.getPoolName(), allVMs.length - dontDelete.size);
                    for (let i = 0; i < allVMs.length; i++) {
                    ...
                    try {
                        ...
                        const stagingPromises = stagingKeys.map((id) => {
                            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                                ...
                                try {
                                    ...
                                    if (!vm &&
                                        ...
                                        if (vm === null || vm === void 0 ? void 0 : vm.host) {
                                            ...
                                            yield this.redis.setex(this.getRedisHostCacheKey() + ':' + id, 3600, JSON.stringify(vm));
                                        }
                                    }
                                }
                                catch (e) {
                                ...
                                ready = yield checkVMReady(vm === null || vm === void 0 ? void 0 : vm.host);
