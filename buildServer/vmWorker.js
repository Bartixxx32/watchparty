...
app.post('/assignVM', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const pool = Object.values(vmManagers).find((mgr) => {
            return ((mgr === null || mgr === void 0 ? void 0 : mgr.getIsLarge()) === Boolean(req.body.isLarge) &&
                (mgr === null || mgr === void 0 ? void 0 : mgr.getRegion()) === req.body.region);
        });
...
app.get('/isFreePoolFull', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const freePool = Object.values(vmManagers).find((mgr) => {
        return ((mgr === null || mgr === void 0 ? void 0 : mgr.getIsLarge()) === false &&
            (mgr === null || mgr === void 0 ? void 0 : mgr.getRegion()) === config_1.default.DEFAULT_VM_REGION);
    });
    let isFull = false;
    if (freePool) {
        const availableCount = yield (redis === null || redis === void 0 ? void 0 : redis.llen(freePool.getRedisQueueKey()));
        const limitSize = (_b = freePool === null || freePool === void 0 ? void 0 : freePool.getLimitSize()) !== null && _b !== void 0 ? _b : 0;
        const currentSize = yield (redis === null || redis === void 0 ? void 0 : redis.get(freePool.getRedisPoolSizeKey()));
